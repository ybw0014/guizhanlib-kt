...
package net.guizhanss.guizhanlib.kt.slimefun.utils
...
// SlimefunItem
fun Location.getSfItem(): SlimefunItem? = BlockStorage.check(this)
fun Block.getSfItem(): SlimefunItem? = location.getSfItem()
